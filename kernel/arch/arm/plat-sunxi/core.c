...
__attribute__ ((weak)) void sunxi_board_init(void);
...
static const char *sun4i_boards_compat[] __initdata = {
	"allwinner,sun4i",
	NULL,
};

static const char *sun5i_boards_compat[] __initdata = {
	"allwinner,sun5i",
	NULL,
};

static const char *sun7i_boards_compat[] __initdata = {
	"allwinner,sun7i",
	NULL,
};
